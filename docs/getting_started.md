# Getting Started with stevefulme1.databricks

Manage Databricks workspaces, clusters, Unity Catalog, IAM, jobs, and secrets.
...
- name: Example playbook
  ...
  gather_facts: false
  collections:
    - stevefulme1.databricks
  tasks:
    - name: Get info
      stevefulme1.databricks.app_info:
        api_url: "{{ api_url }}"
        api_token: "{{ api_token }}"
      register: result
...
- Browse the module documentation: `ansible-doc stevefulme1.databricks.<module_name>`
